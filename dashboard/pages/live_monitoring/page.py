...
try:
    ...
    from dashboard.components.refresh import live_status_text, refresh_controls, render_live_section, rendered_at_label
    from dashboard.components.sidebar import collapse_sidebar_on_page_load
    from dashboard.components.ui import render_meta_row, render_page_header
...
def render_live_monitoring_page() -> None:
    ...
    def _render_history_filters() -> dict[str, Any]:
