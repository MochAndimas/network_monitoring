...
DEFAULT_THRESHOLDS = {
    ...
    "switch_ping_latency_warning": (20.0, "Switch ping latency warning threshold in milliseconds"),
    "switch_ping_latency_critical": (50.0, "Switch ping latency critical threshold in milliseconds"),
    "switch_packet_loss_warning": (1.0, "Switch packet loss warning threshold in percent"),
    "switch_packet_loss_critical": (50.0, "Switch critical packet loss threshold in percent"),
    "switch_jitter_warning": (10.0, "Switch jitter warning threshold in milliseconds"),
    "switch_jitter_critical": (30.0, "Switch critical jitter threshold in milliseconds"),
