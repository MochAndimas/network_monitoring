...
class MetricDailyRollup(Base):
    ...
    ping_numeric_samples: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    packet_loss_samples: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    packet_loss_numeric_samples: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    jitter_samples: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    jitter_numeric_samples: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
