...
class Settings(BaseSettings):
    ...
    telegram_alert_grace_period_seconds: int = 120
    telegram_realtime_severities: str = "critical"
    telegram_realtime_alert_types: str = "device_down,internet_loss,high_packet_loss_critical"
    telegram_realtime_device_types: str = "internet_target,voip,switch,server"
    telegram_non_realtime_device_down_summary_seconds: int = 900
    telegram_site_outage_min_devices: int = 3
    telegram_site_outage_window_seconds: int = 300
    telegram_site_outage_cooldown_seconds: int = 3600
    telegram_summary_severities: str = "warning"
    telegram_summary_alert_types: str = "slow_http_response,slow_dns_resolution"
    telegram_summary_interval_seconds: int = 1800
    telegram_summary_repeat_window_seconds: int = 900
    telegram_summary_repeat_min_count: int = 3
    telegram_flap_suppression_seconds: int = 120
    telegram_flap_repeat_window_seconds: int = 900
    telegram_flap_repeat_min_count: int = 3
    telegram_critical_reminder_interval_seconds: int = 3600
    telegram_voip_alert_grace_period_seconds: int = 300
    telegram_voip_critical_reminder_interval_seconds: int = 28800
    telegram_notification_cooldown_seconds: int = 1800
    ...
    def telegram(self) -> TelegramSettings:
        ...
        return TelegramSettings(
            ...
            realtime_alert_types=self.telegram_realtime_alert_types,
            realtime_device_types=self.telegram_realtime_device_types,
            non_realtime_device_down_summary_seconds=self.telegram_non_realtime_device_down_summary_seconds,
            site_outage_min_devices=self.telegram_site_outage_min_devices,
            site_outage_window_seconds=self.telegram_site_outage_window_seconds,
            site_outage_cooldown_seconds=self.telegram_site_outage_cooldown_seconds,
            summary_severities=self.telegram_summary_severities,
            summary_alert_types=self.telegram_summary_alert_types,
            summary_interval_seconds=self.telegram_summary_interval_seconds,
            summary_repeat_window_seconds=self.telegram_summary_repeat_window_seconds,
            summary_repeat_min_count=self.telegram_summary_repeat_min_count,
            flap_suppression_seconds=self.telegram_flap_suppression_seconds,
            flap_repeat_window_seconds=self.telegram_flap_repeat_window_seconds,
            flap_repeat_min_count=self.telegram_flap_repeat_min_count,
            critical_reminder_interval_seconds=self.telegram_critical_reminder_interval_seconds,
            voip_alert_grace_period_seconds=self.telegram_voip_alert_grace_period_seconds,
            voip_critical_reminder_interval_seconds=self.telegram_voip_critical_reminder_interval_seconds,
